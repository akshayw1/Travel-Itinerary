    ...
    >
      <div className="flex flex-col gap-20">
        <section className="flex flex-col gap-5">
          <h2 className="text-red-500 text-center text-lg font-bold tracking-wide">
            How it works?
          </h2>
        ...
        <section className="flex items-center justify-center gap-28 w-full h-full flex-col md:flex-row">
          <Item
            ...
            icon={<LogIn className="h-8 w-8 text-red-500 dark:text-foreground" />}
            className="rotate-[202deg] hidden md:block"
          />
          <Item
            text="Key in the travel idea"
            description="Tell us about your ideal trip"
            icon={<Lightbulb className="h-8 w-8 text-red-500 dark:text-foreground" />}
          ...
          <Item
            ...
            icon={<PlaneTakeoff className="h-8 w-8 text-red-500 dark:text-foreground" />}
            className="hidden"
          />
        </section>
      </div>
